...
<div class="panel panel-default policy-page">
    ...
    <div class="panel-body policy-page-body">
        ...
        <p>大分类或商品标注为 <strong>EMS 自缴税</strong> 的，采用该方式发货。商品报价<strong>不含 EMS 国际运费</strong>；结算时按包裹<strong>计费总重量</strong>自动匹配下方 EMS 第一区域（中国·中国台湾·韩国）资费，另加 {{ (int) round(config('site.service_fee_rate', 0.15) * 100) }}% 服务费与 300 日元包装费。</p>
