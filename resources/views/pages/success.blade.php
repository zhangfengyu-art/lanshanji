@extends('layouts.app')
@section('title', trans('frontend.pages.success'))
...
<div class="payment-return-wrap">
    <div class="panel panel-default">
        <div class="panel-heading">{{ trans('frontend.pages.success') }}</div>
        <div class="panel-body text-center">
            <h1>{{ $msg }}</h1>
            <p class="text-muted" style="margin:0 0 12px;">支付结果已同步，页面将按最新订单状态继续展示。</p>
