...
$base = dirname(__DIR__) . '/resources/views/payment';

file_put_contents($base . '/alipay_page.blade.php', '@extends(\'layouts.payment_gateway\')
    ...
    <section class="card payment-qr-panel">
      ...
      <div class="side-body">
        <div class="launch-panel">
          ...
          <div class="kv"><span class="k">支付提示</span><span class="v">页面将自动跳转支付宝；若未跳转请手动点击「前往支付宝支付」。</span></motion>
